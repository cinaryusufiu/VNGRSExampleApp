...
typealias CompletionIntBlock = (_ index: Int) -> Void

final class FavoritePokemonPage: VGBasePage {
    ...
    var didTappedCell: CompletionIntBlock?
    
    var viewModel: FavoritePokemonVM? {
        didSet {
            updateUI()
        }
    }
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        cv.contentInset = UIEdgeInsets(top: 100, left: 0, bottom: 100, right: 0)
        return cv
    }()
...
extension FavoritePokemonPage: UICollectionViewDataSource , UICollectionViewDelegate , UICollectionViewDelegateFlowLayout {
